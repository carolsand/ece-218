...
#define WAIT_TIMER        1
#define BACK_UP_TIMER     2 /*make sure this is enabled above and posting to the correct state machine*/
#define TURN_TIMER        3
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "TapeBumpService.h"
// the name of the Init function
#define SERV_2_INIT InitTapeBumpService
// the name of the run function
#define SERV_2_RUN RunTapeBumpService
// How big should this services Queue be?
