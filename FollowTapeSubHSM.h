...
#ifndef SUB_FOLLOWTAPE_HSM_H  // <- This should be changed to your own guard on both
#define SUB_FOLLOWTAPE_HSM_H  //    of these lines
...
/**
 * @Function InitFollowTapeSubHSM(void)
